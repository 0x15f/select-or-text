...
Nova.booting(function (Vue, router, store) {
    Vue.component('index-select-or-custom', __webpack_require__(3));
    Vue.component('detail-select-or-custom', __webpack_require__(6));
    Vue.component('form-select-or-custom', __webpack_require__(9));
});
